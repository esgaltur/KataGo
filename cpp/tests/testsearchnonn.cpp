...
.......xx
    ...
    Search::AnalysisJsonOptions analysisOpts;
    analysisOpts.analysisPVLen = 2;
    analysisOpts.preventEncore = true;
    analysisOpts.includePolicy = false;
    analysisOpts.includeOwnership = false;
    analysisOpts.includeOwnershipStdev = false;
    analysisOpts.includeMovesOwnership = false;
    analysisOpts.includeMovesOwnershipStdev = false;
    analysisOpts.includePVVisits = false;
    analysisOpts.includeNoResultValue = false;
    bool suc = search->getAnalysisJson(perspective, analysisOpts, json);
    testAssert(suc);
    cout << json << endl;
...
.......
    ...
    analysisOpts.analysisPVLen = 2;
    analysisOpts.preventEncore = true;
    analysisOpts.includePolicy = true;
    analysisOpts.includeOwnership = true;
    analysisOpts.includeOwnershipStdev = false;
    analysisOpts.includeMovesOwnership = false;
    analysisOpts.includeMovesOwnershipStdev = false;
    analysisOpts.includePVVisits = true;
    analysisOpts.includeNoResultValue = false;
    bool suc = search->getAnalysisJson(perspective, analysisOpts, json);
    testAssert(suc);
    cout << json << endl;
...
.......
    ...
    analysisOpts.includePolicy = false;
    analysisOpts.includeOwnership = true;
    analysisOpts.includeOwnershipStdev = true;
    analysisOpts.includeMovesOwnership = true;
    analysisOpts.includeMovesOwnershipStdev = true;
    analysisOpts.includePVVisits = false;
    analysisOpts.includeNoResultValue = false;
    bool suc = search->getAnalysisJson(perspective, analysisOpts, json);
    testAssert(suc);
...
xxxxxxxxx
...

  {
    ...
    auto printResults = [](const Search* search, bool allowDirectPolicyMoves) {
      ...
      Search::AnalysisJsonOptions analysisOpts;
      analysisOpts.analysisPVLen = analysisPVLen;
      analysisOpts.preventEncore = preventEncore;
      analysisOpts.includePolicy = includePolicy;
      analysisOpts.includeOwnership = includeOwnership;
      analysisOpts.includeOwnershipStdev = includeOwnershipStdev;
      analysisOpts.includeMovesOwnership = includeMovesOwnership;
      analysisOpts.includeMovesOwnershipStdev = includeMovesOwnershipStdev;
      analysisOpts.includePVVisits = includePVVisits;
      analysisOpts.includeNoResultValue = includeNoResultValue;
      suc = search->getAnalysisJson(
        perspective, analysisOpts, json
      );
